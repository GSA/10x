  ...
  <div class="g-container-desktop margin-bottom-0 padding-x-double padding-top-base margin-top-0">
    ...
    <div class="g-row margin-top-0 border-top-pixel padding-top-base-plus">
      ...
      <div class="g-col usa-body-content padding-x-base-plus font-sans-f8">
        ...
        <p>Use colors from the system palette for your project. In the long run, it’s a better user experience across government when there’s coherence across sites and services. Or course, your mission, project needs, and user needs always come first, but if you plan to <a href="#0">contribute your work back into the system</a> — which helps the system learn, adapt, and improve — those designs will need to conform to the system standards.</p>
