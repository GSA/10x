...
description: 10x wants ideas from City employees that that can mprove the performance of City operations and quality of life in our neighborhoods.
...
10x is currently accepting ideas from all City of Sacramento employees &ndash; Submit your idea before **August 15, 2019** to be considered for our next round of evaluations in early September.
{% else %}

<h2 class="docs-h2">Eligibility</h2>

10x accepts ideas from all current City of Sacramento government employees.
...
<ul class="line-height-small tablet:line-height-base">
  <li class="text-indent-neg-3 padding-left-3 tablet:text-indent-neg-4 tablet:padding-left-4">
    ...
    Create cost savings for City departments.</li>
  <li class="text-indent-neg-3 padding-left-3 tablet:text-indent-neg-4 tablet:padding-left-4">
    <img class="display-line-block width-2 tablet:width-3 margin-right-p5 position-relative bottom-2px vertical-align-middle" src="{{ '/assets/img/check.svg' | relative_url }}" alt="check">
    Improve the performance of City operations, programs, or services.</li>
  <li class="text-indent-neg-3 padding-left-3 tablet:text-indent-neg-4 tablet:padding-left-4">
    <img class="display-line-block width-2 tablet:width-3 margin-right-p5 position-relative bottom-2px vertical-align-middle" src="{{ '/assets/img/check.svg' | relative_url }}" alt="check">
    Have an impact across City government or in our neighborhoods.
  </li>
</ul>
