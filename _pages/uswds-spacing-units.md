...
<div class="clearfix g-container-tablet-plus padding-top-s6 line-height-smallest">
  ...
  <p class="line-height-small font-weight-300 margin-bottom-s4">You can output negative values with a <code class="txt-code">neg-</code> prefix, like <code class="txt-code">u-margin-x-neg-s2</code>.</p>
