...
<div class="font-weight-300 padding-top-2 padding-bottom-4 tablet:padding-top-4 tablet:padding-bottom-6">
  ...
  <div class="g-container-desktop margin-bottom-0 padding-x-4 padding-top-2 margin-top-0">
    ...
    <div class="g-row padding-top-3 border-top-1px">
      ...
      <div class="g-col-9 usa-prose padding-x-3 font-sans-f8">
        ...
        <div class="g-row g-gap margin-y-4 text-align-center">
          <div class="g-col-fill">
            <a href="#0" class="display-flex flex-direction-column justify-content-center min-height-compact border border-radius-large padding-2 color-black-90 text-decoration-none border-color-black-20 hover:border-color-black-90 hover:border-width-2px">
              ...
              <p class="flex-auto width-full margin-bottom-0 font-sans-f6 font-weight-700 line-height-small margin-top-1">Theme palette gallery</p>
              <p class="alex-auto width-full margin-0 margin-top-1 font-sans-f6 line-height-small padding-bottom-1">View and download project theme palettes</p>
            </a>
          </div>
          <div class="g-col-fill">
            <a href="#0" class="display-flex flex-direction-column justify-content-center min-height-compact border border-radius-large padding-2 color-black-90 text-decoration-none border-color-black-20 hover:border-color-black-90 hover:border-width-2px">
              ...
              <p class="flex-auto width-full margin-bottom-0 font-sans-f6 font-weight-700 line-height-small margin-top-1">Get the design assets</p>
              <p class="alex-auto width-full margin-0 margin-top-1 font-sans-f6 line-height-small padding-bottom-1">Use project theme palettes in your Sketch files</p>
            </a>
          </div>
        </div>

        <h2 class="font-sans-f10 margin-top-4 margin-bottom-4 border-top-1px padding-top-2">Using role-based palettes</h2>
        ...
        <div class="margin-top-4 margin-bottom-8">
          <div class="g-row g-gap-small">
            <div class="g-col-7 margin-bottom-1">
              <div class="border-bottom-1px font-mono-f2 padding-bottom-05">60%</div>
            </div>
            <div class="g-col-4">
              <div class="border-bottom-1px font-mono-f2 padding-bottom-05">30%</div>
            </div>
            <div class="g-col-1">
              <div class="border-bottom-1px font-mono-f2 padding-bottom-05">10%</div>
            </div>
          </div>
          <div class="g-row g-gap-small">
            <div class="g-col-7">
        ...
        <aside class="background-color-white-warm-3 padding-3 margin-y-4 border-radius-small">
          <div class="g-row g-gap-large">
            ...
            <div class="g-col-fill">
              ...
              <p class="border-top margin-top-1 padding-top-1 font-sans-f6 font-weight-400">The <strong>secondary</strong> color family of <code class="background-color-mint-50 color-white">Mint</code> functions as a background color for an occasional content type.</p>
              <p class="border-top margin-top-1 padding-top-1 font-sans-f6 font-weight-400">The <strong>warm and cool accent color families</strong> of <code class="background-color-orange-40v color-black-90">Orange</code> and <code class="background-color-cyan-20v color-black-90">Cyan</code> serve as special call-to-action buttons and headings for special content.</p>
              <p class="border-top margin-top-1 padding-top-1 font-sans-f6 font-weight-400"><strong>Neutral</strong> <code class="background-color-black-90 color-white">Black</code> is the color family of most text.</p>
            </div>
          </div>
        </aside>

        <h2 class="font-sans-f10 margin-y-4 border-top-1px padding-top-2">Project theme palette grades</h2>
        ...
        <div class="g-row g-gap">
          <div class="g-col-6">
            <div class="margin-top-3 border border-radius-base padding-2">
              ...
              <div>
                <div class="g-row font-sans-f1 border-top border-color-black-10 margin-top-2 padding-top-1-plus">
                  <div class="g-col-fit font-weight-700">Lightest</div>
                  <div class="g-col-fit margin-left-auto">Grade 1–5</div>
                </div>
                <div class="height-4 display-flex align-items-center  margin-top-05">
              ...
              <div>
                ...
                <div class="height-4 display-flex align-items-center background-color-blue-10 margin-top-05">
              ...
              <div>
                ...
                <div class="height-4 display-flex align-items-center background-color-blue-30 margin-top-05">
                  <div class="margin-x-auto circle-2px background-color-black-90 display-none"></div>
                </div>
                <ul class="swatch-info list-reset font-mono-f1 margin-top-1">
              ...
              <div>
                ...
                <div class="height-4 display-flex align-items-center background-color-blue-50 margin-top-05">
                  <div class="margin-x-auto circle-2px background-color-black-90 display-none"></div>
                </div>
                <ul class="swatch-info list-reset font-mono-f1 margin-top-1">
              ...
              <div>
                ...
                <div class="height-4 display-flex align-items-center background-color-blue-50v margin-top-05">
                  <div class="margin-x-auto circle-2px background-color-black-90 display-none"></div>
                </div>
                <ul class="swatch-info list-reset font-mono-f1 margin-top-1">
              ...
              <div>
                ...
                <div class="height-4 display-flex align-items-center background-color-blue-70 margin-top-05">
                  <div class="margin-x-auto circle-2px background-color-black-90 display-none"></div>
                </div>
                <ul class="swatch-info list-reset font-mono-f1 margin-top-1">
              ...
              <div>
                ...
                <div class="height-4 display-flex align-items-center background-color-blue-90 margin-top-05">
                  <div class="margin-x-auto circle-2px background-color-black-90 display-none"></div>
                </div>
                <ul class="swatch-info list-reset font-mono-f1 margin-top-1">
          ...
          <div class="g-col-6">
            <div class="margin-top-3 border border-radius-base padding-2">
              ...
              <div>
                ...
                <div class="height-4 display-flex align-items-center background-color-mint-30 margin-top-05">
                  <div class="margin-x-auto circle-2px background-color-black-90 display-none"></div>
                </div>
                <ul class="swatch-info list-reset font-mono-f1 margin-top-1">
              ...
              <div>
                ...
                <div class="height-4 display-flex align-items-center background-color-mint-50 margin-top-05">
                  <div class="margin-x-auto circle-2px background-color-black-90 display-none"></div>
                </div>
                <ul class="swatch-info list-reset font-mono-f1 margin-top-1">
              ...
              <div>
                ...
                <div class="height-4 display-flex align-items-center background-color-mint-cool-40v margin-top-05">
                  <div class="margin-x-auto circle-2px background-color-black-90 display-none"></div>
                </div>
                <ul class="swatch-info list-reset font-mono-f1 margin-top-1">
              ...
              <div>
                ...
                <div class="height-4 display-flex align-items-center background-color-mint-70 margin-top-05">
                  <div class="margin-x-auto circle-2px background-color-black-90 display-none"></div>
                </div>
                <ul class="swatch-info list-reset font-mono-f1 margin-top-1">
          ...
          <div class="g-col-6">
            <div class="margin-top-3 border border-radius-base padding-2">
              ...
              <div>
                ...
                <div class="height-4 display-flex align-items-center background-color-orange-40v margin-top-05">
                  <div class="margin-x-auto circle-2px background-color-black-90 display-none"></div>
                </div>
                <ul class="swatch-info list-reset font-mono-f1 margin-top-1">
              ...
              <div>
                ...
                <div class="height-4 display-flex align-items-center background-color-orange-50v margin-top-05">
                  <div class="margin-x-auto circle-2px background-color-black-90 display-none"></div>
                </div>
                <ul class="swatch-info list-reset font-mono-f1 margin-top-1">
          ...
          <div class="g-col-6">
            <div class="margin-top-3 border border-radius-base padding-2">
              ...
              <div>
                ...
                <div class="height-4 display-flex align-items-center background-color-cyan-20v margin-top-05">
                  <div class="margin-x-auto circle-2px background-color-black-90 display-none"></div>
                </div>
                <ul class="swatch-info list-reset font-mono-f1 margin-top-1">
              ...
              <div>
                ...
                <div class="height-4 display-flex align-items-center background-color-cyan-40v margin-top-05">
                  <div class="margin-x-auto circle-2px background-color-black-90 display-none"></div>
                </div>
                <ul class="swatch-info list-reset font-mono-f1 margin-top-1">
          ...
          <div class="g-col-12">
            <div class="margin-top-3 border border-radius-base padding-2 background-color-white">
              ...
              <div>
                ...
                <div class="height-4 display-flex align-items-center margin-top-05 background-color-white-1">
                  <div class="margin-x-auto circle-2px background-color-black-90 display-none"></div>
                </div>
                <ul class="g-row swatch-info list-reset font-mono-f1 margin-top-1">
              ...
              <div>
                ...
                <div class="height-4 display-flex align-items-center margin-top-05 background-color-black-10">
                </div>
                <ul class="g-row swatch-info list-reset font-mono-f1 margin-top-1">
              ...
              <div>
                ...
                <div class="height-4 display-flex align-items-center margin-top-05 background-color-black-30">
                </div>
                <ul class="g-row swatch-info list-reset font-mono-f1 margin-top-1">
              ...
              <div>
                ...
                <div class="height-4 display-flex align-items-center margin-top-05 background-color-black-50">
                </div>
                <ul class="g-row swatch-info list-reset font-mono-f1 margin-top-1">
              ...
              <div>
                ...
                <div class="height-4 display-flex align-items-center margin-top-05 background-color-black-70">
                </div>
                <ul class="g-row swatch-info list-reset font-mono-f1 margin-top-1">
              ...
              <div>
                ...
                <div class="height-4 display-flex align-items-center margin-top-05 background-color-black-90">
                </div>
                <ul class="g-row swatch-info list-reset font-mono-f1 margin-top-1">
        ...
        <h2 class="font-sans-f10 margin-y-4 border-top-1px padding-top-2">Palette gallery</h2>
        ...
        <div class="g-row g-gap margin-top-4">
          <div class="g-col-6">
            <div class="palette-card border border-radius-small padding-1 margin-top-3">
              ...
              <h4 class="font-sans-f5 margin-bottom-1 line-height-smaller">Onondaga</h4>
              <ul class="list-reset g-row g-gap font-sans-f1 font-weight-400 margin-bottom-0 margin-x-0 min-height-6 align-items-flex-start margin-top-05">
                <li class="g-col-auto border-0 background-color-white-warm-4 border-radius-small padding-y-05 padding-x-1 line-height-smallest margin-right-05">professional</li>
                <li class="g-col-auto border-0 background-color-white-warm-4 border-radius-small padding-y-05 padding-x-1 line-height-smallest margin-right-05">young</li>
                <li class="g-col-auto border-0 background-color-white-warm-4 border-radius-small padding-y-05 padding-x-1 line-height-smallest margin-right-05">natural</li>
              </ul><!-- tags -->
              <div class="g-row margin-top-2 align-items-center">
                <a href="#0" class="g-col-auto line-height-smallest font-sans-f1 font-weight-400 padding-y-1 padding-x-2 background-color-black-90 color-white border-radius-small text-decoration-none">
                  Download palette ⇣
                </a><!-- palette-button -->
          ...
          <div class="g-col-6">
            <div class="palette-card border border-radius-small padding-1 margin-top-3">
              ...
              <h4 class="font-sans-f5 margin-bottom-1 line-height-smaller">Federal <span class="font-weight-300">(Original USWDS)</span></h4>
              <ul class="list-reset g-row g-gap font-sans-f1 font-weight-400 margin-bottom-0 margin-x-0 min-height-6 align-items-flex-start margin-top-05">
                <li class="g-col-auto border-0 background-color-white-warm-4 border-radius-small padding-y-05 padding-x-1 line-height-smallest margin-right-05">traditional</li>
                <li class="g-col-auto border-0 background-color-white-warm-4 border-radius-small padding-y-05 padding-x-1 line-height-smallest margin-right-05">straightforward</li>
                <li class="g-col-auto border-0 background-color-white-warm-4 border-radius-small padding-y-05 padding-x-1 line-height-smallest margin-right-05">trustworthy</li>
              </ul><!-- tags -->
              <div class="g-row margin-top-2 align-items-center">
                <a href="#0" class="g-col-auto line-height-smallest font-sans-f1 font-weight-400 padding-y-1 padding-x-2 background-color-black-90 color-white border-radius-small text-decoration-none">
                  Download palette ⇣
          ...
          <div class="g-col-6">
            <div class="palette-card border border-radius-small padding-1 margin-top-3">
              ...
              <h4 class="font-sans-f5 margin-bottom-1 line-height-smaller margin-bottom-0">Pennant</h4>
              <ul class="list-reset g-row g-gap font-sans-f1 font-weight-400 margin-bottom-0 margin-x-0 min-height-6 align-items-flex-start margin-top-05">
                <li class="g-col-auto border-0 background-color-white-warm-4 border-radius-small padding-y-05 padding-x-1 line-height-smallest margin-right-05 margin-top-05">solid</li>
                <li class="g-col-auto border-0 background-color-white-warm-4 border-radius-small padding-y-05 padding-x-1 line-height-smallest margin-right-05 margin-top-05">friendly</li>
                <li class="g-col-auto border-0 background-color-white-warm-4 border-radius-small padding-y-05 padding-x-1 line-height-smallest margin-right-05 margin-top-05">energetic</li>
                <li class="g-col-auto border-0 background-color-white-warm-4 border-radius-small padding-y-05 padding-x-1 line-height-smallest margin-right-05 margin-top-05">outgoing</li>
                <li class="g-col-auto border-0 background-color-white-warm-4 border-radius-small padding-y-05 padding-x-1 line-height-smallest margin-right-05 margin-top-05">all-American</li>
              </ul><!-- tags -->
              <div class="g-row margin-top-2 align-items-center">
                <a href="#0" class="g-col-auto line-height-smallest font-sans-f1 font-weight-400 padding-y-1 padding-x-2 background-color-black-90 color-white border-radius-small text-decoration-none">
                  Download palette ⇣
          ...
          <div class="g-col-6">
            <div class="palette-card border border-radius-small padding-1 margin-top-3">
              ...
              <h4 class="font-sans-f5 margin-bottom-1 line-height-smaller">Marine</h4>
              <ul class="list-reset g-row g-gap font-sans-f1 font-weight-400 margin-bottom-0 margin-x-0 min-height-6 align-items-flex-start margin-top-05">
                <li class="g-col-auto border-0 background-color-white-warm-4 border-radius-small padding-y-05 padding-x-1 line-height-smallest margin-right-05">no nonsense</li>
                <li class="g-col-auto border-0 background-color-white-warm-4 border-radius-small padding-y-05 padding-x-1 line-height-smallest margin-right-05">professional</li>
                <li class="g-col-auto border-0 background-color-white-warm-4 border-radius-small padding-y-05 padding-x-1 line-height-smallest margin-right-05">conservative</li>
              </ul><!-- tags -->
              <div class="g-row margin-top-2 align-items-center">
                <a href="#0" class="g-col-auto line-height-smallest font-sans-f1 font-weight-400 padding-y-1 padding-x-2 background-color-black-90 color-white border-radius-small text-decoration-none">
                  Download palette ⇣
          ...
          <div class="g-col-6">
            <div class="palette-card border border-radius-small padding-1 margin-top-3 display-flex flex-direction-column">
              <h4 class="font-sans-f5 margin-bottom-05 line-height-smaller order-2">Cascade</h4>
              ...
              <ul class="order-3 list-reset g-row g-gap font-sans-f1 font-weight-400 margin-bottom-0 margin-x-0 min-height-6 align-items-flex-start margin-top-05">
                <li class="g-col-auto border-0 background-color-white-warm-4 border-radius-small padding-y-05 padding-x-1 line-height-smallest margin-right-05 margin-top-05">fresh</li>
                <li class="g-col-auto border-0 background-color-white-warm-4 border-radius-small padding-y-05 padding-x-1 line-height-smallest margin-right-05 margin-top-05">compassionate</li>
                <li class="g-col-auto border-0 background-color-white-warm-4 border-radius-small padding-y-05 padding-x-1 line-height-smallest margin-right-05 margin-top-05">energetic</li>
                <li class="g-col-auto border-0 background-color-white-warm-4 border-radius-small padding-y-05 padding-x-1 line-height-smallest margin-right-05 margin-top-05">healthy</li>
              </ul><!-- tags -->
          ...
          <div class="g-col-6">
            <div class="palette-card border border-radius-small padding-1 margin-top-3 display-flex flex-direction-column">
              <h4 class="font-sans-f5 margin-bottom-05 line-height-smaller order-2">Columbia</h4>
              <div class="g-row g-gap-2px order-first">
                <!-- ========================================= -->
                <div class="g-col-fill">
                  <div class="height-1 display-flex align-items-center">
              ...
              <ul class="order-3 list-reset g-row g-gap font-sans-f1 font-weight-400 margin-bottom-0 margin-x-0 min-height-6 align-items-flex-start margin-top-05">
                <li class="g-col-auto border-0 background-color-white-warm-4 border-radius-small padding-y-05 padding-x-1 line-height-smallest margin-right-05">clean</li>
                <li class="g-col-auto border-0 background-color-white-warm-4 border-radius-small padding-y-05 padding-x-1 line-height-smallest margin-right-05">fresh</li>
                <li class="g-col-auto border-0 background-color-white-warm-4 border-radius-small padding-y-05 padding-x-1 line-height-smallest margin-right-05">earthy</li>
                <li class="g-col-auto border-0 background-color-white-warm-4 border-radius-small padding-y-05 padding-x-1 line-height-smallest margin-right-05 margin-top-05">earnest</li>
              </ul><!-- tags -->
              <div class="order-4 g-row margin-top-2 align-items-center">
                <a href="#0" class="g-col-auto line-height-smallest font-sans-f1 font-weight-400 padding-y-1 padding-x-2 background-color-black-90 color-white border-radius-small text-decoration-none">
                  Download palette ⇣
        ...
        <h2 class="font-sans-f10 margin-y-4 border-top-1px padding-top-2">Downloading and using palettes</h2>
...
<pre class="max-width-full background-color-white-warm-4 padding-2 white-space-pre-wrap margin-y-4"><code class="font-mono-f1 padding-0">@import 'uswds-project-settings';
