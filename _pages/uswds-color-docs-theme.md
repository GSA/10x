        ...
        <div class="margin-top-4 margin-bottom-8">
          <div class="g-row g-gap-small">
            <div class="g-col-7 margin-bottom-1">
              <div class="border-bottom-1px font-mono-f2 padding-bottom-p5">60%</div>
            </div>
            <div class="g-col-4">
              <div class="border-bottom-1px font-mono-f2 padding-bottom-p5">30%</div>
            </div>
            <div class="g-col-1">
              <div class="border-bottom-1px font-mono-f2 padding-bottom-p5">10%</div>
            </div>
          </div>
          <div class="g-row g-gap-small">
            <div class="g-col-7">
        ...
        <div class="g-row g-gap">
          <div class="g-col-6">
            <div class="margin-top-3 border border-radius-base padding-2">
              ...
              <div>
                <div class="g-row font-sans-f1 border-top border-color-black-10 margin-top-2 padding-top-1p5">
        ...
        <div class="g-row g-gap margin-top-4">
          <div class="g-col-6">
            <div class="palette-card border border-radius-small padding-1 margin-top-3">
              ...
              <ul class="list-reset g-row g-gap font-sans-f1 font-weight-400 margin-bottom-0 margin-x-0 min-height-6 align-items-flex-start margin-top-p5">
          ...
          <div class="g-col-6">
            <div class="palette-card border border-radius-small padding-1 margin-top-3 display-flex flex-direction-column">
              <h4 class="font-sans-f5 margin-bottom-p5 line-height-smaller order-2">Cascade</h4>
              ...
              <ul class="order-3 list-reset g-row g-gap font-sans-f1 font-weight-400 margin-bottom-0 margin-x-0 min-height-6 align-items-flex-start margin-top-p5">
          ...
          <div class="g-col-6">
            <div class="palette-card border border-radius-small padding-1 margin-top-3 display-flex flex-direction-column">
              <h4 class="font-sans-f5 margin-bottom-p5 line-height-smaller order-2">Columbia</h4>
              <div class="g-row g-gap-2px order-first">
                <!-- ========================================= -->
                <div class="g-col-fill">
                  <div class="height-1 display-flex align-items-center">
